...
async def setup_login():
    """Open Perplexity in visible mode, wait for login, and save cookies"""
    logger.info("=" * 80)
    logger.info("🤖 PERPLEXITY LOGIN SETUP")
    logger.info("=" * 80)
    logger.info("This will open Perplexity in a browser window.")
    ...
    try:
        ...
        logger.info("\n" + "=" * 80)
        logger.info("🔐 PLEASE LOG IN TO PERPLEXITY")
        logger.info("=" * 80)
        logger.info("1. The browser window should now be open at perplexity.ai")
        logger.info("2. Log in with your account (Google/Email)")
        logger.info("3. Wait until you see the Perplexity search interface")
