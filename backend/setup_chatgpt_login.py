...
async def setup_login():
    """Open ChatGPT in visible mode, wait for login, and save cookies"""
    logger.info("=" * 80)
    logger.info("🤖 CHATGPT LOGIN SETUP")
    logger.info("=" * 80)
    logger.info("This will open ChatGPT in a browser window.")
    ...
    try:
        ...
        logger.info("\n" + "=" * 80)
        logger.info("🔐 PLEASE LOG IN TO CHATGPT")
        logger.info("=" * 80)
        logger.info("1. The browser window should now be open at chat.openai.com")
        logger.info("2. Log in with your OpenAI account")
        logger.info("3. Wait until you see the ChatGPT chat interface")
